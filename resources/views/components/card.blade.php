            ...
            <div class="text-start">
                ...
                <div class="w-full flex flex-col items-center">
                 ...
                 <div class="flex items-center gap-4">
                    <a class="flex justify-center items-center py-2 bg-amarelo text-white px-6 mt-4  rounded-full font-semibold" href="{{$data['edit_url'] ?? ''}}"> Editar </a>
                    <a class="flex justify-center items-center py-2 bg-amarelo text-white px-6 mt-4  rounded-full font-semibold" href="{{$data['delete_url'] ?? ''}}"> Deletar </a>
                 </div>
